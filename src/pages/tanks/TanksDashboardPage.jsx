  ...
  return (
    <div className="space-y-4 sm:space-y-6 animate-fade-in relative min-h-0 flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 flex-shrink-0">
        <div>
          <h1 className="text-xl sm:text-2xl font-black text-brand-heading tracking-tight uppercase">Fuel Tank Metrics</h1>
          <p className="text-xs sm:text-sm text-brand-body font-medium">Monitoring fuel tank storage levels and hardware logs</p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 flex-shrink-0 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
        <StatCard 
